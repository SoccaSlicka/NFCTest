...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String OMEGA_BEAM = "Attempting to beam regardless!";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* try {
                    if (myTag == null){
                        Toast.makeText(context, OMEGA_BEAM, Toast.LENGTH_LONG).show();
                    write2(message.getText().toString(), myTag);
                }
                    else {
                        write(message.getText().toString(),myTag);
                    }*/
...
//        String tagId = new String(msgs[0].getRecords()[0].getType());
  ...
  /*  private void write2(String text, Tag tag) throws IOException, FormatException {
        NdefRecord[] records = {createRecord(text)};
        NdefMessage message = new NdefMessage(records);
        // Get an instance of Ndef for the tag.
        Ndef ndef = Ndef.get(tag);
